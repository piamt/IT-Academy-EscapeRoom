...
public class EnigmaDAOImpl implements EnigmaDAO, ParsingCallback<Enigma> {
    ...
    @Override
    public void addEnigma(Enigma enigma, Integer roomId) throws CallFailedException {
    ...
    @Override
    public void addEnigmaToUser(Integer userId, Integer enigmaId) throws CallFailedException {
        List<Attribute> attributeList = new ArrayList<>();
